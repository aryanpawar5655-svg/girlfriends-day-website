...
1. **Photos**: put `photo1.jpeg`, `photo2.jpeg`, `photo3.jpeg` in `images/` (see `images/README.md`).
...
Already deployed at https://syedbilal1997.github.io/girlfriends-day-website/. To push updates:
...
- `images/`: photos and mascot stickers
